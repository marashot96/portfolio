...
Обратите внимание: все файлы, используемые в программах, хранятся в этой [директории](/Python/Files%20from%20progs). Описание того, где какой файл используется, можно посмотреть [здесь](/Python/Files%20from%20progs/About%20this%20directory.md).
