...
Обратите внимание: все файлы, используемые в программах, хранятся в этой [директории](/Files from progs). Описание того, где какой файл используется, можно посмотреть [здесь](/Files from progs/About this directory.md).
