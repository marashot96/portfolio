...
| Матем. статистика, модели | Применяю теоретические методы статистики для анализа данных, строю и оцениваю статистические модели, включая вероятностные процессы, регрессионный анализ и методы проверки гипотез. |  ★★★★★ |
