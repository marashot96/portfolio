...
[Здесь](/A-B tests/theory.md) приведено подробное теоретическое обоснование применение A/B-тестирования, а мы далее будут приведены некоторые практические примеры его применения мной.
</p>
