...
### 1. [Полное исследование выборки](/A-B tests/statistic)
<p align="justify"> В <a href='/A-B tests/statistic.xlsx'>файле</a> формата MS Excel приведенполное исследование для выборки размер n. Файл был разработан мной для решения повседневных статистических задач базового уровня. С помощью этого файла любой желающий, вставив в соотвествующий лист выборочную последовательность элементов и задав длину каждого интервала, на которую надо разбить эту последовательность (равномерное разбиение на интервалы), сможет получить все стастистические данные выборки: </p>
- Среднее выборочное, ...
