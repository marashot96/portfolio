...
| 2 | [`joins_and_subqueries`](/SQL/join-subqueries.md) | Соединения таблиц и подзапросы | Более сложный анализ, с использованием всех видов соединения таблиц и подзапросов |
